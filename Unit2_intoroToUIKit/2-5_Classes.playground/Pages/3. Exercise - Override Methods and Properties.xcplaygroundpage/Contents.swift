...
defender.moveRight()
print("After moveRight(), \(defender.name)'s position is \(defender.position) now")
defender.fire()
print("RemainingFirePower is \(defender.remainingFirePower) now.")
 ...
 */
print("Before Shield Strength: \(defender.shieldStrength), Health: \(defender.health)")
defender.wasHit()
print("After Shield Strength: \(defender.shieldStrength), Health: \(defender.health)")
