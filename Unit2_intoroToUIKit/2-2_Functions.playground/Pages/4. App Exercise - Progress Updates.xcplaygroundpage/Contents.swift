...
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    if (currentDistance / currentTime) - (totalDistance / goalTime) >= 0 {
       print("Keep it up!")
    } else {
        print("You've got to push it just a bit harder!")
    }
}
pacing(currentDistance: 100, totalDistance: 100, currentTime: 200, goalTime: 200)
pacing(currentDistance: 50, totalDistance: 100, currentTime: 100, goalTime: 200)
pacing(currentDistance: 40, totalDistance: 100, currentTime: 100, goalTime: 200)
