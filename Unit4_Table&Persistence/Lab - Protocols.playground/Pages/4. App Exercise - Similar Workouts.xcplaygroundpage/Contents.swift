...
let rw = RunningWorkout(distance: 10.9, time: 20.2)
let sw = SwimmingWorkout(distance: 2.0, time: 2.1)

simpleWorkoutDescription(workout: rw)
simpleWorkoutDescription(workout: sw)
