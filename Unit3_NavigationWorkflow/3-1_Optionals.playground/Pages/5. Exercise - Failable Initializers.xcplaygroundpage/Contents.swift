 ...
 */
var computer1 = Computer(ram: 1, yearManufactured: 2016)
var computer2 = Computer(ram: 0, yearManufactured: 2016)

if let computer = computer1 {
    print("RAM: \(computer.ram), Manufatured in \(computer.yearManufactured)")
} else {
    print("This is nil")
}
