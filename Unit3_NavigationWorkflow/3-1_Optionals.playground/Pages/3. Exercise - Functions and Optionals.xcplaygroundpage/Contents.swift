...
func checkAge(ageStr: String) -> Int? {
    if let age = Int(ageStr) {
        ...
        print("Sorry, something went worong. Can you please re-enter your age?")
...
if let age = checkAge(ageStr: "17e") {
    print("Age is \(age)")
} else {
    print("This is nil")
}
...
func calcItems(itemName: String) -> Double? {
    if let stockVal = stock[itemName] {
        if stockVal > 0 {
...
if let price = calcItems(itemName: "Chips") {
    print(price)
} else {
